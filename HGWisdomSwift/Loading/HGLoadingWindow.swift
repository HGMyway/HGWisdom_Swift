...
//            return firstWindow is HGLoadingWindow ? nil : firstWindow?.rootViewController
//        }
//        set { /* Do nothing */ }
//    }
...
//        if !(notification.object is HGLoadingWindow) {
//            HGLoadingWindow.shared.isHidden = true
//            HGLoadingWindow.shared.isHidden = false
//        }
//    }
...
//    }
    ...
    func handleRotate(_ orientation: UIInterfaceOrientation) {
        ...
        DispatchQueue.main.async {
            HGLoadingCenter.default.currentLoading?.view.setNeedsLayout()
        }
    }
